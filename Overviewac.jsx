  ...
  return (
    <>
      <div className='container-fluid'>
        <h1 className='text-center' style={{background: '#1bbd36'}}>Academic Project</h1>
        <div className='row'>
        <div className='col-sm6' style={{ display: 'flex' }}>
        <img
        src='https://img.freepik.com/free-photo/people-working-with-documents-laptop_23-2147656651.jpg?size=626&ext=jpg&ga=GA1.1.1401409355.1698466385&semt=ais'
